...
CxxTest::StaticSuiteDescription suiteDescription_isCircularTests( "isCircularTest.h", 8, "isCircularTests", suite_isCircularTests, Tests_isCircularTests );

static class TestDescription_suite_isCircularTests_test1 : public CxxTest::RealTestDescription {
public:
 TestDescription_suite_isCircularTests_test1() : CxxTest::RealTestDescription( Tests_isCircularTests, suiteDescription_isCircularTests, 11, "test1" ) {}
...
public:
 TestDescription_suite_isCircularTests_test2() : CxxTest::RealTestDescription( Tests_isCircularTests, suiteDescription_isCircularTests, 12, "test2" ) {}
...
public:
 TestDescription_suite_isCircularTests_test3() : CxxTest::RealTestDescription( Tests_isCircularTests, suiteDescription_isCircularTests, 13, "test3" ) {}
...
public:
 TestDescription_suite_isCircularTests_test4() : CxxTest::RealTestDescription( Tests_isCircularTests, suiteDescription_isCircularTests, 14, "test4" ) {}
